...
## [v1.8.0](https://github.com/jorgibravo/toycollectiontracker/compare/v1.7.2...v1.8.0)

### Fixed

- Closed #89 Added different view options [`#89`](https://github.com/jorgibravo/toycollectiontracker/issues/89)
- Fixed #74 Combined add new to wishlist, add new to collection and search to search page only that has add new option if no results [`#74`](https://github.com/jorgibravo/toycollectiontracker/issues/74)
- Closed #87 Added quick search option to search in make, brand, title, minicollection at once from the filter bar with one click [`#87`](https://github.com/jorgibravo/toycollectiontracker/issues/87)
- Closed #82 Fixed css for the save button on XS size [`#82`](https://github.com/jorgibravo/toycollectiontracker/issues/82)
- Closed #84 Filter app bar and Bulk update bar has been completely redesigned, filter, sort, view moved into separate tabs [`#84`](https://github.com/jorgibravo/toycollectiontracker/issues/84)
- Closed #85 You can add items in BULK from the search, wanted, sale pages and even add details [`#85`](https://github.com/jorgibravo/toycollectiontracker/issues/85)
- Closed #88 You can filter to show only cars with images or to view your cars withi missing pictures [`#88`](https://github.com/jorgibravo/toycollectiontracker/issues/88)
- Closed #86 The owned and wanted markers are more visible and wanted is animated [`#86`](https://github.com/jorgibravo/toycollectiontracker/issues/86)
- Fixed #76 On the Sellers page the sold cars are no longer calculated into the count [`#76`](https://github.com/jorgibravo/toycollectiontracker/issues/76)

## [v1.7.2](https://github.com/jorgibravo/toycollectiontracker/compare/v1.7.1...v1.7.2) - 2021-05-31

### Fixed

- Fixed #73 Users can now add to their collection even if they dont have a collection item yet [`#73`](https://github.com/jorgibravo/toycollectiontracker/issues/73)

## [v1.7.1](https://github.com/jorgibravo/toycollectiontracker/compare/v1.7.0...v1.7.1) - 2021-05-27
